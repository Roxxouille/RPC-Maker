    ...
    <Row className="presHome__body">
      ...
      <Col>
        ...
        <Row className="presHome__body__content">
          ...
          Que vous n'y connaissiez rien, que vous ne soyez pas sur ou que vous n'ayez juste pas l'envie de mettre les mains dans le camboui, faites comme toutes ces personnes avant vous,  n'hesitez plus et les passionne faire ce qui les passionnes !
        </Row>
      </Col>
    </Row>
  </div>
